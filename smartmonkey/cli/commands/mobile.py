"""Mobile (Native) app testing command"""
...
def mobile_command(device, package, steps, strategy, output, screenshots, runs, ai_goal, ai_workspace, ai_credentials, ai_scenario):
    """Run SmartMonkey exploration on a native Android app"""

    click.echo("=" * 60)
    click.echo("SmartMonkey - Mobile App Testing")
    click.echo("=" * 60)
